...
<head>
    ...
    <title>Pengelolaan Perhotelan UBD | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('adminLTE/img/user8-128x128.jpg') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('tentang.index') }}" class="nav-link {{ Request::segment(1) == 'tentang'  ? 'active' : '' }}">
                                        ...
                                        <p>Tentang Prodi Pengelolaan Perhotelan</p>
                                    </a>
                                </li>                                
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('bidangminat.index') }}" class="nav-link {{ Request::segment(1) == 'bidangminat'  ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-book"></i>
                                        <p>MK Bidang Minat</p>
                                    </a>
                                </li>
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline-block">
                <b>Pengelolaan Perhotelan UBD</b>
            </div>
        </footer>
